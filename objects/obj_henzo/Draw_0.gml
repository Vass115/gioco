...
// Calcola la lunghezza della barra della vita in base alla vita attuale
// Calcola la larghezza della barra della vita
draw_self();

var bar_width = 30; // Lunghezza della barra
var bar_height = 2; // Altezza della barra
